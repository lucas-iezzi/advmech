...
OUTPUT_ARCH(pic32mx)
ENTRY(_reset)
SEARCH_DIR("=/data01/build/bamboo/xml-data/build-dir/M32DEV-WOZ14-MB/install-mingw/pic32mx/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
/*

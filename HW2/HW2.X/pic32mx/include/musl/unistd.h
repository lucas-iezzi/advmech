...
extern __attribute__((section(".bss.optarg"))) char *optarg;
extern __attribute__((section(".data.optvars"))) int optind, opterr;
extern __attribute__((section(".bss.optvars"))) int optopt;

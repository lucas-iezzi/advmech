...
ipv4 =  ipaddress.IPv4Address("10.0.0.113")
netmask =  ipaddress.IPv4Address("255.255.255.0")
gateway =  ipaddress.IPv4Address("10.0.1.1")
...
def webpage():
    ...
    <br>
    <p><form accept-charset="utf-8" method="POST">
    <button class="button" name="Stopwatch" value="Pressed" type="submit">Stopwatch Pressed</button></a></p></form>
    <p class="dotted">Time Elapsed = {elapsed}</p>
    </body></html>
    """
    return html
